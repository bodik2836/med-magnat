...
@section('content')
    <div class="container">
        ...
        <a class="btn btn btn-outline-success" href="/admin/post/add">Додати новину</a>
        ...
        <table class="table mt-3">
            ...
            @foreach($posts as $post)
                <tr>
                    ...
                    <td>
                        <a class="edit" href="/admin/post/edit/{{ $post->id }}" title="Редагувати">
                        ...
                        <a class="delete" href="/admin/post/delete/{{ $post->id }}" title="Видалити">
